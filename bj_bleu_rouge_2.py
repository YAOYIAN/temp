...
path2 = "G:/d_ctr/SupQA_enhance/lw/SupQA_enhance_v1/temp/g_t_a_dataset.csv"
...
with open(path1, "r", encoding="gbk") as f1, \
    ...
    for row1, row2 in tqdm(zip(reader1, reader2)):
        ...
        val2 = row2['answer_simulate']
        src_list.append(val1.lower())
        output.append(val2.lower())
...
# # 查看数据结构
# for item in data:
#     for re in item['product_reviews']:
#         print(re)
